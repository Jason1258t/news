...
example:
{
    ...
    "og": {
      "url": "https://vtech-news.ru/#/articles/grind-humanity-origin",
...
На основе этого переформатируй эту статью для хранения, чтобы все выглядело красиво, сильно не изменяй содержимое по возможности.
